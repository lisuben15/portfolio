...
const about = {
  title: "Sobre mí",
  description:
    "Desarrollador web con experiencia en frontend y backend. Me enfoco en crear soluciones innovadoras y optimizadas, siempre buscando aprender y mejorar mis habilidades.",
  info: [
    {
      fieldName: "Nombre",
...
const education = {
  ...
  title: 'Mi educación',
  description: "Formación académica en programación y desarrollo de software, con un enfoque práctico y orientado a la resolución de problemas.",
  items: [
    {
...
const skills = {
  title: "Habilidades",
  description: "Desarrollador web con experiencia en tecnologías frontend y backend, diseño de interfaces y optimización del rendimiento.",
  skillList: [
    {
      icon: <FaHtml5 />,
      name: "html 5",
